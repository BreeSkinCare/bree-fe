                    ...
                    {isSmallScreen ? (
                        ...
                        >
                            <svg
                                ...
                                fill="none"
                            >
                                <circle cx="19.5" cy="19.5" r="19.5" transform="rotate(90 19.5 19.5)" fill="#EFE4FD"/>
                                <path d="M12 18.8C11.4477 18.8 11 19.2478 11 19.8C11 20.3523 11.4477 20.8 12 20.8L12 18.8ZM27.1071 20.5072C27.4976 20.1166 27.4976 19.4835 27.1071 19.0929L20.7431 12.729C20.3526 12.3385 19.7195 12.3385 19.3289 12.729C18.9384 13.1195 18.9384 13.7527 19.3289 14.1432L24.9858 19.8L19.3289 25.4569C18.9384 25.8474 18.9384 26.4806 19.3289 26.8711C19.7195 27.2616 20.3526 27.2616 20.7431 26.8711L27.1071 20.5072ZM12 20.8L26.4 20.8L26.4 18.8L12 18.8L12 20.8Z" fill="#4D2499"/>
                            </svg>
                        </button>
                    )}
                </div>
